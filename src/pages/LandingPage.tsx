...
import { ArrowRight, Star, Download, Users, Code, Zap, Sparkles } from 'lucide-react';
...
const companyUsages = ['Flutterwave', 'Oxygen Finance', 'Paystack', 'Kuda Bank', 'Chipper Cash'];
  return (
    <div className="min-h-screen overflow-hidden">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <br />
                  <span className="text-gray-700 text-4xl lg:text-5xl">for TypeScript</span>
                </motion.h1>
                ...
                >
                  ...
                  <span className="font-semibold text-secondary-600">financial calculations</span>, and{' '}
                  <span className="font-semibold text-success-600">money operations</span>.{' '}
              ...
              >
                {[
                  ...
                  { icon: Download, count: 10, suffix: 'K+', label: 'Downloads' },
                  { icon: Users, count: 500, suffix: '+', label: 'Developers' },
        ...
        <div className="relative container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive tools for handling money in your applications. From simple formatting 
              to complex financial calculations - we've got you covered.
            </p>
          </motion.div>
      ...
      {/* Quick Start Section */}
      <section className="py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden" id='get-started'>
        {/* Animated background */}
        <motion.div
      ...
      <section className="py-32 bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Build better financial applications with Monie Utils. 
            Trusted by developers worldwide for production applications.
          </p>
...
const features = [
  {
    ...
    description: 'Format currencies with locale-specific rules, symbols, and cultural conventions for global applications.',
    icon: Code,
    href: '/demo/currency-formatting',
  },
  {
    title: 'Financial Calculations',
    description: 'Calculate interest, loans, investments, and returns with precision and reliability.',
    icon: Users,
    href: '/demo/financial-calculations',
  },
  {
    title: 'Validation & Parsing',
    description: 'Validate amounts and parse currency strings safely with comprehensive error handling.',
    icon: Star,
  ...
  {
    title: 'Type Safety',
    description: 'Built with TypeScript for excellent developer experience and compile-time safety.',
    icon: Zap,
    href: '/docs/typescript',
  },
  {
    title: 'Zero Dependencies',
    description: 'Lightweight and tree-shakeable with no external dependencies. Perfect for performance.',
    icon: Sparkles,
